...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'ai.apiKeySet': 'API key already set (leave blank to keep)',
    ...
    'ch.webGuide.2': 'Access at <a href="http://localhost:3030" target="_blank">http://localhost:3030</a> (or your server IP).',
    ...
    'ch.qqGuide.1': 'Go to <a href="https://q.qq.com" target="_blank">QQ Open Platform</a> \u2192 Create a new Bot application.',
    'ch.qqGuide.2': 'In the app settings, note the <b>App ID</b> and <b>Client Secret</b> (AppSecret).',
    'ch.qqGuide.3': 'Configure the bot\u2019s messaging permissions: enable <b>Group</b> and <b>C2C</b> message intents.',
    'ch.qqGuide.4': 'Add the bot to a QQ group or start a direct conversation with it.',
    'ch.qqGuide.5': 'Paste the App ID and Client Secret above, click Save, then toggle the switch to enable.',
    ...
    'user.passwordSet': 'Password is set',
    'user.passwordNotSet': 'No password set',
    'user.currentPassword': 'Current password',
    'user.newPassword': 'New password',
    'user.confirmPassword': 'Confirm password',
    'user.setPassword': 'Set Password',
    'user.changePassword': 'Change Password',
    'user.removePassword': 'Remove Password',
    'user.removePasswordConfirm': 'Remove password protection?',
    'user.passwordMismatch': 'Passwords do not match',
    'user.passwordSaved': 'Password saved',
    'user.passwordRemoved': 'Password removed',
    'user.wrongPassword': 'Incorrect current password',
    'user.passwordRequired': 'Please enter a password',
  ...
  'zh-CN': {
    ...
    'ch.webGuide.2': '访问地址：<a href="http://localhost:3030" target="_blank">http://localhost:3030</a>（或服务器 IP）。',
    ...
    'ch.qqGuide.1': '前往 <a href="https://q.qq.com" target="_blank">QQ 开放平台</a> \u2192 创建一个新的机器人应用。',
    'ch.qqGuide.2': '在应用设置中，记录 <b>App ID</b> 和 <b>Client Secret</b>（AppSecret）。',
    'ch.qqGuide.3': '配置机器人的消息权限：启用<b>群聊</b>和<b>单聊</b>消息意图。',
    'ch.qqGuide.4': '将机器人添加到 QQ 群或直接与机器人发起对话。',
    'ch.qqGuide.5': '将 App ID 和 Client Secret 填入上方字段，点击保存，然后打开开关启用。',
    'user.profile': '个人信息',
    'user.name': '名称',
    'user.appearance': '外观',
    'user.theme': '主题',
    ...
    'user.logout': '退出登录',
    'user.password': '密码',
    'user.passwordSet': '已设置密码',
    'user.passwordNotSet': '未设置密码',
    'user.currentPassword': '当前密码',
    'user.newPassword': '新密码',
    'user.confirmPassword': '确认密码',
    'user.setPassword': '设置密码',
    'user.changePassword': '修改密码',
    'user.removePassword': '移除密码',
    'user.removePasswordConfirm': '确定移除密码保护？',
    'user.passwordMismatch': '两次输入的密码不一致',
    'user.passwordSaved': '密码已保存',
    'user.passwordRemoved': '密码已移除',
    'user.wrongPassword': '当前密码错误',
